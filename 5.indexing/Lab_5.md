...
```
SQLite version: 
SQLite 3.34.1 2021-01-20 14:10:07 10e20c0b43500cfb9bbc0eaa061c57514f715d87238f4d835880cd846b9ebd1f
zlib version 1.2.11
gcc-5.2.0
Findings:
The indexes all seemed to work, but the EXPLAIN QUERY PLAN's didn't seem to do the queries themselves and the timer just gave the time that it took to do the EXPLAIN QUERY PLAN query. So, I'm not sure if I got a really accurate idea of how much exactly the indexes helped.
